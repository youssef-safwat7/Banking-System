...
Taller::Taller(String^ name, String^ email, String^ phoneNumber, String^ password)
	: name(name), email(email), phoneNumber(phoneNumber), password(password) {}

void Taller::AddCustomer(int id, String^ name, String^ email, String^ password, int age, String^ phoneNumber, String^ address, float accountBalance) {
...
bool Taller::withdraw(Customer^ customer, float amount) {
...
float Taller::GetCustomerAccountBalance(Customer^ customer) {
	return customer->GetAccountBalance();
}

bool Taller::deposit(Customer^ customer, float amount) {
...
bool Taller::transfer(Customer^ sender, Customer^ receiver, float amount) {
...
void Taller::DeleteCustomer(int id) {
	try {
